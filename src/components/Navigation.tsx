...
const socialLinks = [
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/7syedmudassarali/' },
  { label: 'GitHub', href: 'https://github.com/7syedmudassarali' },
  { label: 'Mail', href: 'mailto:syed.mudassaralishah13@gmail.com' },
]
